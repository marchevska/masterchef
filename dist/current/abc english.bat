...
copy "%cd%\abc english\img\episodes\american\*.png" "%cd%\img\episodes\american\*.png"
copy "%cd%\abc english\img\episodes\hawaiian\*.png" "%cd%\img\episodes\hawaiian\*.png"
copy "%cd%\abc english\img\episodes\japanese\*.png" "%cd%\img\episodes\japanese\*.png"
copy "%cd%\abc english\img\episodes\mexican\*.png" "%cd%\img\episodes\mexican\*.png"
copy "%cd%\abc english\img\episodes\russian\*.png" "%cd%\img\episodes\russian\*.png"
